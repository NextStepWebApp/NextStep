...
NextStep is the main project of the NextStep ecosystem and serves as the foundation for all other related projects. It provides schools with a way to keep track of their alumni and their post-graduation academic paths.

**Warning:** The web app is close to a stable release. There are some core features that are not yet finished. Please check the to-do list below before deploying for production use.
...
- Add home page (finished)
- Add data analyses (finished)
- Fix alumni data import/export (Part of the cloud connection)

### Features to do after first stable release ###
- Add a log system
