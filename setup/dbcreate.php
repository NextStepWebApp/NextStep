...
$query = <<<EOF
      ...
      students_company TEXT,
      students_job_title TEXT,
      students_linkedin_url TEXT,
      students_website TEXT,
      students_bio TEXT,
      students_class_id INTEGER NOT NULL,
      students_country_id INTEGER NOT NULL,
      students_city_id INTEGER NOT NULL,
      students_school_id INTEGER NOT NULL,
      students_education_program_id INTEGER NOT NULL,
      students_status_id INTEGER NOT NULL,
      students_accessibility_id INTEGER NOT NULL,
