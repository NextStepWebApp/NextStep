...
tableCreate($query, $db, "THEACHERS");
...
if (!$stmt) {
    ...
    echo "Theachers table created successfully\n";
...
$query = <<<EOF
      ...
      students_username TEXT NOT NULL,
      students_email TEXT NOT NULL UNIQUE,
      students_password TEXT NOT NULL,
      students_phone_number UNIQUE,
      students_class_secondary_school_id,
      students_school_id,
      students_status_id,
